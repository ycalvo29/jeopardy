...
function buildSchemaFromAST(documentNode, options) {
    ...
    const connectFeature = (_a = schema.coreFeatures) === null || _a === void 0 ? void 0 : _a.getByIdentity(connectSpec_1.connectIdentity);
    const handledConnectTypeNames = new Set();
    if (connectFeature) {
        const connectFeatureDefinition = (0, knownCoreFeatures_1.coreFeatureDefinitionIfKnown)(connectFeature.url);
        if (connectFeatureDefinition) {
            const connectTypeNamesInSchema = new Set(connectFeatureDefinition.typeSpecs()
    ...
    if ((_b = options === null || options === void 0 ? void 0 : options.validate) !== null && _b !== void 0 ? _b : true) {
        schema.validate();
    }
    return schema;
}
