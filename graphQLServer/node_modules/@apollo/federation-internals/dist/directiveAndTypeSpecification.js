...
function createDirectiveSpecification({ name, locations, repeatable = false, args = [], composes = false, supergraphSpecification = undefined, useJoinDirective = false, staticArgumentTransform = undefined, }) {
    ...
    if (composes) {
        ...
        composition = {
            ...
            useJoinDirective: useJoinDirective !== null && useJoinDirective !== void 0 ? useJoinDirective : false,
            argumentsMerger,
