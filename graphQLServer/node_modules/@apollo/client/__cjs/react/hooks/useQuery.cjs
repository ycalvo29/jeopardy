...
function useQuery(query, ...[options]) {
    ...
    useQuery_, (0, useApolloClient_js_1.useApolloClient)(typeof options === "object" ? options.client : undefined))(query, options);
}
...
function useOptions(query, options, defaultOptions) {
    return (0, index_js_1.useDeepMemo)(() => {
        if (options === constants_js_1.skipToken) {
            const opts = (0, internal_1.mergeOptions)(defaultOptions, {
                query,
                fetchPolicy: "standby",
            });
